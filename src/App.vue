...
<template>
  <div class="app-container">
      ...
      <div class="header-container">
        ...
        <template v-if="currentUser">
          <div class="header-actions">
            ...
            <div @click="triggerFileInput" class="user-profile-btn" title="Clique para alterar a foto de perfil">
              <img v-if="currentUser.avatar" :src="currentUser.avatar" class="user-avatar" alt="Perfil" />
              <div v-else class="user-avatar-placeholder">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
              </div>
              <span class="user-greeting">Olá, <strong>{{ currentUser.username }}</strong></span>
            </div>

            <input type="file" ref="fileInput" accept="image/png, image/jpeg, image/jpg" style="display: none" @change="handleFileUpload" />

            <button @click="showAddGameModal = true" class="btn-apple btn-apple-primary">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
              <span>Adicionar Jogo</span>
            </button>
            <button @click="logout" class="btn-apple btn-apple-danger">
      ...
      <main v-else-if="!isPlaying">
        <section v-if="featuredGame" class="hero-section">
          ...
          <div class="hero-content">
            ...
            <button @click="playGame(featuredGame)" class="btn-play-hero">
        ...
        <section>
            ...
            <div v-for="game in favoriteGames" :key="game.id" @click="playGame(game)" class="game-card">
              ...
              <div class="game-card-info">
                ...
                <div class="game-card-actions">
                    <button @click="(e) => toggleFavorite(game, e)" :class="['btn-icon', isFavorite(game.id) ? 'btn-icon-active' : '']" title="Remover dos Favoritos">
                    ...
                    <button v-if="game.id.startsWith('custom_')" @click="(e) => removerJogoLocal(game.id, e)" class="btn-icon btn-icon-danger" title="Remover Jogo Local">
          ...
          <div v-else class="empty-state">
            ...
            <p>Nenhum jogo favorito ainda. Explore e adicione seus preferidos!</p>
          </div>
        </section>
          ...
          <div class="games-grid">
            <div v-for="game in userCustomGames" :key="game.id" @click="playGame(game)" class="game-card">
              ...
              <div class="game-card-info">
                ...
                <div class="game-card-actions">
                    <button @click="(e) => toggleFavorite(game, e)" :class="['btn-icon', isFavorite(game.id) ? 'btn-icon-active' : '']" title="Adicionar aos Favoritos">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" :fill="isFavorite(game.id) ? 'currentColor' : 'none'" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>
                    </button>
                    <button @click="(e) => removerJogoLocal(game.id, e)" class="btn-icon btn-icon-danger" title="Remover Jogo Local">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
                    </button>
                </div>
              </div>
    ...
    <footer class="footer" v-if="currentUser">
      ...
      <p>© 2026 Virtual World. Projetado com excelência.</p>
    </footer>
